...
namespace project2019
{
    public partial class WebForm9 : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select txtuname, txtpwd from flowerreg where txteid=@email and txtuname=@user_name", con);
...

            {
                ...
                if (sdr.Read())
                {
                    UserName = sdr["txtuname"].ToString();
                    Password = sdr["txtpwd"].ToString();
